...
public class RectangleApp {
	...
	public static void main( String[] args ) {
		...
		System.out.println("Scaled rect 1: x="+myRect1.getWidth()+" "+myRect1.getHeight());
		System.out.println("Scaled rect 2: x="+myRect2.getWidth()+" "+myRect2.getHeight());
		System.out.println("Scaled rect 3: x="+myRect3.getWidth()+" "+myRect3.getHeight());
