...
public class RectangleApp {
	...
	public static void main( String[] args ) {
		...
		System.out.println("Scaled rect 1: x="+myRect1.width+" "+myRect1.height);
		System.out.println("Scaled rect 2: x="+myRect2.width+" "+myRect2.height);
		System.out.println("Scaled rect 3: x="+myRect3.width+" "+myRect3.height);
